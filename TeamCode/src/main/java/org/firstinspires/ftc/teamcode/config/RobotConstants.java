...
public class RobotConstants {
    public static final double outtakeOpenPos = 0.4;
    ...
    public static final double intakeMiddlePos = 0.23;
    ...
    public static final double outtakeBehindPos = 0.075;
    ...
    public static final int outtakeSliderHPlayerSpecimenPosition = 2480;
    public static final int outtakeSliderReleasePosition = 1400;
    public static final double outtakeSliderStopAmperage = 1.4;
