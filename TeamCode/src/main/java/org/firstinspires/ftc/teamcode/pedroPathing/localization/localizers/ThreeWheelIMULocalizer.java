...
public class ThreeWheelIMULocalizer extends Localizer {
    ...
    public ThreeWheelIMULocalizer(HardwareMap map, Pose setStartPose) {
        ...
        leftEncoderPose = new Pose(6.1, 4.5, 0);
        rightEncoderPose = new Pose(6.1, -4.5, 0);
        strafeEncoderPose = new Pose(-3.5, 0.8, Math.toRadians(90));
        ...
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "leftRearMotor"));
